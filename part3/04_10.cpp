//@compile clang++ part3/04_10.cpp -std=c++2b -Wall -Wextra -Wpedantic
...
//  ------------------------------------------------------------------------------------------
    ...
    static_assert(has_v < int, Deque < int, double > > == true);

    static_assert(has_v < char, Deque < int, double > > == false);
